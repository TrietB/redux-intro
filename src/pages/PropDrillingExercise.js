...
const RootComponent = (props) => {
  ...
  const addProductToCart = (newProduct) => {
    const productList = cart.products.map((cartProduct)=> {
    ...
    const totalPrice = cart.totalPrice + newProduct.price
    setCart({products: productList, totalPrice: totalPrice })
  }
      ...
      <Grid container justifyContent="center">
        ...
        <Grid item xs={8} >
          <div style={{ display: "flex", justifyContent: "space-between" }}>
            ...
            variant="success" sx={{ width: "5rem" }} >
              Add
            </Button>
            <Button 
            onClick={()=> props.removeProduct(props.product)}
            variant="error" sx={{ width: "5rem" }}>
              Remove
            </Button>
          </div>
        </Grid>
      ...
      <Grid container justifyContent="center">
        ...
        <Grid item xs={8} >
          <div style={{ display: "flex", justifyContent: "space-between" }}>
            ...
            variant="success" size="sm" style={{ width: "5rem" }}>
              Add
            </Button>
            <Button 
            onClick={()=> props.removeProduct(props.product)}
            
            variant="error" size="sm" style={{ width: "5rem" }}>
              Remove
            </Button>
          </div>
        </Grid>
